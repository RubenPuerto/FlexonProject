<%-- 
    Document   : admin
    Created on : Nov 3, 2016, 6:27:59 PM
    Author     : RubenP
--%>
...
<%
    ...
    String Nombre_Completo = (String)request.getSession().getAttribute("UserName");
          ...
          <ul id="main-menu" class="nav navbar-nav navbar-right">
            <li class="dropdown hidden-xs">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                    <span class="glyphicon glyphicon-user padding-right-small" style="position:relative;top: 3px;"></span> <%=Nombre_Completo %> 
              ...
              <ul class="dropdown-menu">
                ...
                <li class="divider"></li>
                <li><a tabindex="-1" href="logout.jsp">Salir</a></li>
              </ul>
            </li>
          </ul>
